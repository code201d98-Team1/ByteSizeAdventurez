...
Every person on your team is an asset. This is your chance to discover the hidden strengths and areas for growth for each team member. Describe at least:

1. What are the key strengths of each person on the team?

    - See Below under 'Team Member' Section
...
3. How often will you take breaks?
    ...
    - Every hour 10 min. If everyone is down we take a hype break, play Pump up the Jam for 30 seconds, dancing optional.

4. What is your plan if you start to fall behind?

    - Lean on your teammates, share resources, grab a TA, reassess priorities and reassign tasks if necessary.
...
6. What is your strategy for ensuring everyone’s voice is heard?
    ...
    - Open floor policy that is already agreed upon in this group. Every decision, concern, success is floored.

7. How will you ensure that you are creating a safe environment where everyone feels comfortable speaking up?

    - Psychological safety and the universal policy of 'don't be a jerk'
...
### Schedule your practice session (TBD STILL!)
...
2. How will you share the repository with your teammates?
    ...
    - Heather created an org, we all have full access and how to use terminal to create, view, and merge pulls.

    - https://github.com/code201d98-Team11d98-Team1 

3. What is your Git flow?

    - Each day create feature branches as individual users to code and maintain, named accordingly to the feature we're working on for the task assigned, then communicate upon a desire to push, pull and merge, assign one person to approved the pull request. Gain agreement, review, and throw the changes onto the development branch for the rest of the group to then pull from. At the end of a development spring we push all changes to the dev branch and review changes as a team, then merge pull requests.

Will you be using a PR review workflow? If so, consider:

4. How many people must review a PR?

    - 1 other person reviews feature branch PR

5. Who merges PRs?

    - Person reviewing feature branch PR
...
7. How will you communicate that it’s time to merge?
    ...
    - We’ll be in communication during working hours using the agreed upon rules and communication platforms.
